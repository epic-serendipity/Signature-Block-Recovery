...
if [[ -z "${ZSH_VERSION-}" ]]; then
    complete -o nospace -o default -o bashdefault -F _python_argcomplete recover-signatures
else
    ...
    if [[ $zsh_eval_context == *func ]]; then
        ...
        compdef _python_argcomplete recover-signatures
    fi
fi
